...
const tiles: Tile[] = [
  ...
  },
  {
    ...
    caption: "Il bar non chiude.",
    w: 1280,
    h: 1024,
  },
  {
    src: crowd,
    alt: "Folla elegante di spalle sotto fasci di luce rossa",
    className: "md:col-span-12 aspect-[16/9] md:aspect-[21/9] md:h-[420px]",
    caption: "03:17 — non vuoi più andartene.",
    w: 1024,
    h: 1280,
  },
];
