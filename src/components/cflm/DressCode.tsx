...
import content from "@/content/dresscode.json";
    ...
    <div className="relative mx-auto max-w-6xl px-6 md:px-12">
      ...
      <Reveal delay={150}>
        <h2 className="font-logo text-5xl md:text-8xl text-foreground leading-[0.95] tracking-tight max-w-3xl">
          <span data-text={content.heading} className="glitch">{content.heading}</span> <span className="italic text-blood">{content.heading_highlight}</span>.
        </h2>
      </Reveal>
      <Reveal delay={350}>
