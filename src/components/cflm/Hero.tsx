      ...
      <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 gap-8 px-6 pb-20 pt-8 md:grid-cols-12 md:px-12 md:pt-16">
          ...
          <h1 className="font-logo font-normal leading-[0.95] tracking-tight animate-fade-up" style={{ animationDelay: ".15s" }}>
            ...
            <span className="block text-[14vw] md:text-[7.5vw] text-foreground">
              BE<img
                ...
                alt="V"
                aria-label="V"
                className="inline-block align-[-0.18em] h-[0.95em] w-auto mx-[-0.02em] drop-shadow-[0_0_25px_hsl(var(--blood)/.7)]"
              />E
            </span>
        ...
        <div className="md:col-span-5 relative flex items-center justify-center">
          ...
          <img
            ...
            className="relative z-10 mt-10 w-72 md:w-[26rem] mix-blend-screen invert hue-rotate-180 saturate-200 flicker drop-shadow-[0_20px_60px_hsl(var(--blood)/.6)]"
            width={520}
            height={520}
          />
        </div>
